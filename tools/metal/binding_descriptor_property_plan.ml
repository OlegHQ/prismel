...
let p ?(attributes = []) owner name header signature introduced =
  entry ~attributes ~owner ~name ~header ~signature ~introduced ()
...
let entries =
  ...
  ; p ~attributes:a "MTLCompileOptions" "languageVersion" "Metal/MTLLibrary.h" "MTLLanguageVersion" "10.11"
  ; p ~attributes:a "MTLCompileOptions" "mathFloatingPointFunctions" "Metal/MTLLibrary.h" "MTLMathFloatingPointFunctions" "15.0"
  ; p ~attributes:a "MTLCompileOptions" "mathMode" "Metal/MTLLibrary.h" "MTLMathMode" "15.0"
  ...
  ; p ~attributes:a "MTLComputePipelineDescriptor" "maxCallStackDepth" "Metal/MTLComputePipeline.h" "NSUInteger" "11.0"
  ...
  ; p ~attributes:a "MTLHeapDescriptor" "resourceOptions" "Metal/MTLHeap.h" "MTLResourceOptions" "10.15"
  ...
  ; p "MTLTextureDescriptor" "resourceOptions" "Metal/MTLTexture.h" "MTLResourceOptions" "10.11"
  ...
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "inheritCullMode" "Metal/MTLIndirectCommandBuffer.h" "BOOL" "26.0"
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "inheritDepthBias" "Metal/MTLIndirectCommandBuffer.h" "BOOL" "26.0"
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "inheritDepthClipMode" "Metal/MTLIndirectCommandBuffer.h" "BOOL" "26.0"
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "inheritDepthStencilState" "Metal/MTLIndirectCommandBuffer.h" "BOOL" "26.0"
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "inheritFrontFacingWinding" "Metal/MTLIndirectCommandBuffer.h" "BOOL" "26.0"
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "inheritPipelineState" "Metal/MTLIndirectCommandBuffer.h" "BOOL" "10.14"
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "inheritTriangleFillMode" "Metal/MTLIndirectCommandBuffer.h" "BOOL" "26.0"
  ...
  ; p ~attributes:a "MTLIndirectCommandBufferDescriptor" "maxKernelThreadgroupMemoryBindCount" "Metal/MTLIndirectCommandBuffer.h" "NSUInteger" "14.0"
