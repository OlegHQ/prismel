# MTL4 residual qualification (190 IDs) — superseded duplicate

**Correction:** this package is non-countable. Commit `2c7e165` had already
landed `Binding_metal4_manifest` with the identical 190 IDs and digest before
this qualification was committed. The exact intersection is therefore
190/190, not zero. Keep these files only as redundant generator/safe-model
evidence; they must never contribute additional throughput or bound coverage.
...
Exact intersection with `Binding_metal4_manifest` from `2c7e165`: **190**.
