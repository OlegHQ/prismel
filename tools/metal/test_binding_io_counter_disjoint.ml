...
let ()=
 let claimed=Binding_io_counter_manifest.ids in
 ...
 let forbidden=["MTLDevice";"MTLRenderPipeline";"MTLMeshRenderPipeline";"MTLTileRenderPipeline";
 ...
 if List.length claimed<>111 then failwith"count drift";
 print_endline"io/counter111 disjoint from every static prepared manifest and corrected Device94 owners"
