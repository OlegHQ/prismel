...
let packed_names=["R16Snorm";"R16Unorm";"R8Snorm";"R8Unorm";"RG11B10Float";"RG16Snorm";"RG16Unorm";"RG8Snorm";"RG8Unorm";"RGB10A2Unorm";"RGB9E5Float";"RGBA16Snorm";"RGBA16Unorm";"RGBA8Snorm";"RGBA8Unorm";"RGBA8Unorm_sRGB"]
let expected_ids=List.map(fun name->"enum-case:MTLDataType:MTLDataType"^name)(resource_names@packed_names)
