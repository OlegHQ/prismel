...
let require_classification declaration =
  let expected =
    if Binding_direct_plan.is_safe_device_identifier declaration.identifier
       ...
       || List.mem declaration.identifier Binding_metal4_native32_reachability.promotable_ids
       || List.mem declaration.identifier Binding_metal4_final9_reachability.promotable_ids
       || List.mem declaration.identifier Binding_metal4_pending41_reachability.remaining_promotable_ids
       || List.mem declaration.identifier
            Binding_shader_safe_reachability.promotable_ids
       || List.mem declaration.identifier
            Binding_mesh_tile_safe_reachability.promotable_ids
       || List.mem declaration.identifier Binding_mesh_tile_compile_reachability.promotable_ids
       || List.mem declaration.identifier
