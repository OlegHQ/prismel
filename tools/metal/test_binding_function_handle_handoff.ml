...
let () =
  ...
  Printf.printf "FunctionHandle8: typed scalar identity4 + device/name ownership snapshot4; require owner identity, copied UTF-8, destroyed rejection, and exact resource-ID conformance\n%!"
