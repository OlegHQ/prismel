...
| Native runtime | `r10_native_scene2_correctness_2026-08-28.md`, `runtime_next_native_stability_2026-08-27.md`, `runtime_next_native_r11_candidate_protocol_2026-08-27.md` | Native scene lowering, repeated-frame stability, readback, and lifecycle evidence. |
