...
let gpu_film_texture value ~width ~height=match ensure"Runtime_next_orchestrator.gpu_film_texture"value with
...
let scene_family=function Scene2->Scene_execution.Scene2|Scene2_textured->Scene2_textured|Scene3->Scene3|Scene3_points->Scene3_points
  ...
  |Scene3_shadow_stencil->Scene3_shadow_stencil|Ui->Ui
