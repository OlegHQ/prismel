...
module Render_pipeline = struct
  ...
  module Mesh_tile = struct
    ...
    type mesh_descriptor={raw:Metal_raw.handle;lifetime:lifetime;functions:function_handle list;archives:binary_archive list}
    type tile_descriptor={raw:Metal_raw.handle;lifetime:lifetime;function_:function_handle;archives:binary_archive list;libraries:dynamic_library list}
