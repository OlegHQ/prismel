...
int main(){@autoreleasepool{
 ...
 if(@available(macOS 26.0,*)){
  ...
  MTL4StitchedFunctionDescriptor*stitched=[MTL4StitchedFunctionDescriptor new];stitched.functionGraph=nil;stitched.functionDescriptors=@[];need(stitched.functionGraph==nil&&stitched.functionDescriptors.count==0,@"stitched descriptor roundtrip");
  MTL4RenderPassDescriptor*pass=[MTL4RenderPassDescriptor new];pass.depthAttachment=nil;pass.stencilAttachment=nil;pass.rasterizationRateMap=nil;MTLSamplePosition samples[2]={MTLSamplePositionMake(0.25f,0.25f),MTLSamplePositionMake(0.75f,0.75f)};[pass setSamplePositions:samples count:2];MTLSamplePosition copied[2]={};need([pass getSamplePositions:copied count:2]==2&&copied[0].x==0.25f&&copied[1].y==0.75f&&pass.depthAttachment!=nil&&pass.stencilAttachment!=nil&&pass.rasterizationRateMap==nil,@"render-pass graph roundtrip");
