...
type blend_shape_mask_source = Blend_shapes.mask_source = Blend_mask_first_input | Blend_mask_shape
...
type attribute_mirror_owner = Attribute_mirror.owner = Mirror_point_attributes
  | Mirror_vertex_attributes
  | Mirror_primitive_attributes

type attribute_mirror_group_use = Attribute_mirror.group_use = Mirror_group_as_source
...
type group_range_filter = Group_ops.range_filter = { select : int; of_ : int; offset : int }
...
type group_copy_conflict = Group_ops.copy_conflict = Copy_skip | Copy_overwrite | Copy_add_suffix
...
type invalid_group_name_policy = Group_ops.invalid_name_policy = Ignore_invalid | Force_valid
type group_name_overlap = Group_ops.name_overlap = First_group | Last_group | Error_on_overlap
type group_bounds = Group_ops.bounds =
  | Bounds_box of { minimum : Prismel_math.Vec3.t; maximum : Prismel_math.Vec3.t }
  | Bounds_sphere of { center : Prismel_math.Vec3.t; radius : float }
type group_containment = Group_ops.containment = Fully_contained | Partially_contained
