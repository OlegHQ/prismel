...
val submit : t -> Command.t -> (receipt,Ogpu_core.Error.t) result
...
val submit_render_pass_sync : t -> Render_pass.t ->
  (synchronous_submission,Ogpu_core.Error.t) result
...
module Private : sig
  ...
  val take_scoped_completion : t -> (unit,Ogpu_core.Error.t) result option
end
