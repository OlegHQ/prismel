...
module Private=struct
  ...
  let argument_encoder value ~buffer_index=match argument_function value with None->error"Ogpu_metal.Pipeline.argument_encoder"Ogpu.Error.Invalid_state"fragment function was not retained"|Some function_->(match Metal.Function.argument_encoder function_~buffer_index with Error e->Error(Device.of_metal_error~operation:"Ogpu_metal.Pipeline.argument_encoder" e)|Ok encoder->Ok encoder)
