...
val plan_triangle : ray_tracing:bool -> buffer_size:int64 -> offset:int64 ->
  ...
  (triangle_plan, Ogpu_core.Error.t) result
...
val build : Device.t -> t -> scratch:Buffer.t -> scratch_offset:int64 ->
  (Ogpu_core.Acceleration.description, Ogpu_core.Error.t) result
val refit : Device.t -> t -> scratch:Buffer.t -> scratch_offset:int64 ->
  (Ogpu_core.Acceleration.description, Ogpu_core.Error.t) result
val copy : Device.t -> t -> (t * Ogpu_core.Acceleration.description, Ogpu_core.Error.t) result
val compact : Device.t -> t -> (Ogpu_core.Acceleration.description, Ogpu_core.Error.t) result
