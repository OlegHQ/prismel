...
val create_render_runtime_msl : ?primitive_topology:Metal.Render_pipeline.primitive_topology -> ?blend:Ogpu.Pipeline.blend -> cache -> Device.t -> Ogpu.Pipeline.render_descriptor -> (t,Ogpu.Error.t) result
