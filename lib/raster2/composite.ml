...
let blend mode s d=match mode with Copy->s|Source_over->over s d|Add->rgba(clamp(ch s 24+ch d 24))(clamp(ch s 16+ch d 16))(clamp(ch s 8+ch d 8))(clamp(ch s 0+ch d 0))|Multiply->rgba((ch s 24*ch d 24+127)/255)((ch s 16*ch d 16+127)/255)((ch s 8*ch d 8+127)/255)((ch s 0*ch d 0+127)/255)
