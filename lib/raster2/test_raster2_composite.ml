...
let exact=[Copy,0xc8643280l;Source_over,0xa86040a0l;Add,0x8c8291a0l;
  Multiply,0x243848a0l;Screen,0x7c7285a0l;Subtract,0x001e5fa0l]in
...
List.iter(fun blend->if color~blend~source~destination:0xabcdef00l<>source then
  failwith"source-over transparent destination leaked rgb")[Source_over;Alpha];
