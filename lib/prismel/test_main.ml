let tests = [
  "test_prismel_api", Test_prismel_api.run;
  "test_prismel_api_batch_d", Test_prismel_api_batch_d.run;
  "test_prismel_api_batch_a", Test_prismel_api_batch_a.run;
  "test_prismel_api_batch_b", Test_prismel_api_batch_b.run;
  "test_prismel_api_batch_c", Test_prismel_api_batch_c.run;
  "test_prismel_api_batch_c_scene_parity", Test_prismel_api_batch_c_scene_parity.run;
  "test_scene_rounded_cache", Test_scene_rounded_cache.run;
  "test_automatic_text_cache", Test_automatic_text_cache.run;
  "test_prismel_api_batch_e", Test_prismel_api_batch_e.run;
