...
type t={handle:ring_kind Handle.t;capacity:int64;alignment:int64;max_slots:int;mutable cursor:int64;mutable next:int64;mutable slots:reservation list;mutable completed:int64}
