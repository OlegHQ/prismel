...
type t={descriptor:descriptor;raster_state:raster_state;resources:(int64*Command.access)array}
...
let create ?(raster_state=default_raster_state) device descriptor=
