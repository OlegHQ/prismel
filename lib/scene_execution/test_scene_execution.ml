...
let oversized_frame () =
  ...
  if Scene_execution.cache_entries renderer<>64 then failwith">64 frame escaped bounded cache";
  Ogpu.Backend_mock.clear_trace control;
  ...
  if Scene_execution.cache_entries renderer<>64 then failwith"exact frame escaped bounded cache";
